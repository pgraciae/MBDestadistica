...
Sale que 'basic.9y' y 'university.degree' son los  que tienen mas * pero no se que es la relacion "Junta las dos categorias con mas similitud en efecto y semantica y el rest"

```{r}
mod.glm0 <- glm(p2_train$y~.,p2_train$education,family=binomial)    # estimacion del modelo
summary(mod.glm0) 
```
